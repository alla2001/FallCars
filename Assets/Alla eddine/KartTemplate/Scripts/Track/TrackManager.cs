...
namespace KartGame.Track
{
    ...
    public class TrackManager : MonoBehaviour
    {
        ...
        private bool m_IsRaceRunning;
        private Dictionary<IRacer, Checkpoint> m_RacerNextCheckpoints = new Dictionary<IRacer, Checkpoint>(16);
        private TrackRecord m_SessionBestLap = TrackRecord.CreateDefault();
        private TrackRecord m_SessionBestRace = TrackRecord.CreateDefault();
        private TrackRecord m_HistoricalBestLap;
        private TrackRecord m_HistoricalBestRace;
        ...
        public void LoadRacers()
        {
            ...
            for (int i = 0; i < allRacerArray.Length; i++)
            {
                ...
                if (!m_RacerNextCheckpoints.ContainsKey(racer))
                    m_RacerNextCheckpoints.Add(racer, checkpoints[0]);
            }
        }
